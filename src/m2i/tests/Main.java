...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Instancier la liste d'ingrédients a partir du contenu du CSV
		...
		for (String[] i : contenuCSV) {
			...
			String nom = i[0];
			float apports = Float.parseFloat(i[1]); // a convertir en float
		...
		Ingredient fanta = ingredients.get_ingredient(87);
		fanta.set_Select(false);
