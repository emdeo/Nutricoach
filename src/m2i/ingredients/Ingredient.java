...
/*
 * Suggestion : générer la liste d'objets Ingredient à partir d'un fichier CSV (ou autre format).
 * 
...
public class Ingredient implements Serializable {
	...
	private float _quantite; // grammes (la quantité est fixée quand on crée/consulte une recette, pas quand
								// l'objet est instancié)

	private Categorie _categorie; // fruit, poisson, laitage...
	private String[] _repas; // liste des repas dans lesquels l'ingrédient peut être utilisé

	/**
	 * Constructeur (la 1ère lettre du nom est en capitale)
	 * 
	 * @param _nom
	 * @param _apports
	 * @param _categorie
	...
	public void modifier(Ingredient i) {
		/*
		 * L'attribut 'nom' n'est pas modifié puisqu'on suppose qu'il s'agit du même
		 * ingrédient
		 */
	...
	/**
	 * Vérifie si deux ingrédients portent le même nom.
	 * 
	 * @param o
	 * @return
	 */
